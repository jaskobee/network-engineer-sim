...
export function createClientInstance(templateId) {
  ...
  return {
    ...
    revenueTotal: 0,
    growthStage: 0,
    // Background-contract SLA state (see engine/contractClock.js). A dormant
    // client stops issuing new service tickets until a future re-engagement
    // mechanic brings them back — the record itself is never deleted.
    dormant: false,
